...
\only<1->{
\begin{textblock*}{6.0cm}(10.1cm,1.0cm)
\centering{\small
According to T.~Pedersen [1]
\begin{equation*}
...
\only<3->{
\begin{textblock*}{7.0cm}(8.0cm,6.6cm)
\begin{itemize}
...
\small{
    \begin{empheq}[innerbox=\fbox]{align}
        \max_{\omega}{\mathcal{A}_{\mathrm{opt}}} = \frac{4 \sqrt{\varepsilon_1} \sigma'}{(\sqrt{\varepsilon_2} + \sqrt{\varepsilon_1} + \sigma')^2}\,, \omega = E_\nu/\hbar\,, \nu=1s,2s \notag
    \end{empheq}}
\end{textblock*}
}
...
\only<1->{
\begin{textblock*}{12.0cm}(0.8cm,2.3cm)
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{Figures/absorption_of_beta.jpg}
\end{figure}
\end{textblock*}
}
...
\only<3->{
\begin{textblock*}{14.0cm}(0.7cm,4.4cm)
\begin{center}
    \includegraphics[scale=0.5]{Figures/polariton_dispersion_relation.jpg}
\end{center}
\end{textblock*}
}
