...
\begin{figure}
    \centering
    \includegraphics[scale=0.28]{Figures/absorption_of_beta_panel_a.png}
\end{figure}
\end{textblock*}
}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.28]{Figures/absorption_of_beta_panel_b.png}
\end{figure}
\end{textblock*}
}
...
\begin{frame}{Summary}
    ...
    \begin{textblock*}{8cm}(8.0cm,1.0cm)
        ...
        \begin{figure}
            \centering
            \includegraphics[scale=0.25]{Figures/absorption_of_omega_a.png}
        \end{figure}}
    \end{textblock*}
    \begin{textblock*}{8cm}(8.0cm,4.4cm)
        ...
        \begin{figure}
            \centering
            \includegraphics[scale=0.22]{Figures/absorption_of_beta_panel_a.png}
        \end{figure}}
    \end{textblock*}
