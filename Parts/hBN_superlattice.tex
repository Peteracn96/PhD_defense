...
\begin{figure}
    \centering
    \includegraphics[scale=0.3]{Figures/absorption_of_beta_panel_a.png}
\end{figure}
\end{textblock*}
}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.3]{Figures/absorption_of_beta_panel_b.png}
\end{figure}
\end{textblock*}
}
...
\begin{column}{0.33\textwidth}
 \uncover<1,2>{
   \begin{figure}
    \centering
        \includegraphics[width=0.7\linewidth]{Figures/polariton_a.png}
   \end{figure}
  }      
 \end{column}
\begin{column}{0.33\textwidth}
 \uncover<1,3>{
  ...
  \begin{figure}
    \centering
        \includegraphics[width=0.7\linewidth]{Figures/polariton_b.png}
   \end{figure}
   }
 \end{column}
 \begin{column}{0.33\textwidth}
 \uncover<1,4>{
  \begin{figure}
    \centering
        \includegraphics[width=0.7\linewidth]{Figures/polariton_c.png}
   \end{figure}
   }
 \end{column}
\end{columns}
