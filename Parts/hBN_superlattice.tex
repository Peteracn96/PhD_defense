    ...
    \begin{textblock*}{6.2cm}(9.5cm,1.cm)        
        ...
        \begin{exampleblock}{}
            ...
            \begin{itemize}\setlength{\itemsep}{6pt}
                \item<4-> To have $\beta \sim 1$, $L\sim40$~nm, $V_0\sim40$~meV
                \item<5-> D.~R.~Danielsen et al. - \textit{ACS Nano} \textbf{19} 22 (2025)
                \item<6-> G.~Ermolaev et al. - \textit{Arxiv} \textbf{2509} 18866 (2024)
            \end{itemize}
        \end{exampleblock}}
    \end{textblock*}
