...
\begin{frame}{Motivation}
    \begin{columns}[T]
        ...
        \column{.5\linewidth}
        \only<1->{
            \textbf{Rytova--Keldysh model} \only<4->{\textcolor{ForestGreen}{What can we do with it?}}
            \begin{equation*}
        ...
        \column{.5\linewidth}
        \onslide<3->{
        \textbf{Full numerical \textit{ab initio}} \only<5->{\textcolor{ForestGreen}{Can we optimize?}}
            \begin{equation*}
