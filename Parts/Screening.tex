...
% \column{.5\linewidth}
    ...
    \onslide<4->{
        ...
        \end{empheq}
        [1] Jack Deslippe et al. - \textit{Comp. Phys. Comm.} \textbf{183} 6 (2012) $\leftarrow$ BerkeleyGW
    }
...
\begin{frame}{Bloch states in the TB approx.}
     ...
     \begin{columns}
        ...
        \begin{equation*}
           \left(\mathbf{C}^{n\bk}\right)_{i \alpha} = C^{n \bk}_{i \alpha} \to  \text{TB coefficients}
        \end{equation*}
}
...
\begin{frame}{Exciton computation scheme with the Xatu code}
    ...
    \begin{enumerate}
        ...
        \item Compute the exciton (next slides) \itemsep=2em
    \end{enumerate}
...
\begin{frame}{Macroscopic dielectric function: results}
    ...
    \begin{columns}
        \column{.5\linewidth}
        \onslide<1->{Does $\varepsilon^{-1}_{\bG \bG'} (\bq)$ converge?} \onslide<3->{\textcolor{red}{Clearly no!}}
        ...
        \onslide<5->{
            ...
            %\vspace{-6.0cm}
                \begin{enumerate}\setlength{\itemsep}{10pt}
                    ...
                    \item<9-> $\varepsilon^{\mathrm{2D}}(\bq) = 1/\langle \varepsilon^{-1}_{\bzero \bzero}(\bq,z,z') \rangle$
                \end{enumerate}
                \vspace{0.3cm}
                \onslide<10->{Also, the Coulomb potential is truncated in $z$ as\\
...
\begin{frame}{Excitons with the Xatu code}
   ...
   \begin{equation*}
    ...
    \onslide<3->{and (albeit in \textit{ab initio} $X$ uses the bare potential $v_c$)}
...
\begin{frame}{Excitons in \ch{hBN}: numerical results}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{cc||cccccc}
            ...
            \multicolumn{1}{|c|}{\multirow{4}{*}{$G^X_{c}$}} & 0 & \multicolumn{1}{c|}{X} & 4.14935                & 5.5566                      & 5.75416                  & 6.011076               & $E_b >$ gap        \\
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{cc||cccccc}
            ...
            &   & \multicolumn{6}{c|}{$G^{\varepsilon}_c$}                                            \\ \cline{3-8}
            &                                                & 0                          & 3                & 5.1              & 6              & 8                      & 9                       \\ \cline{8-8} \hline \hline
            \multicolumn{1}{|c|}{\multirow{4}{*}{$G^X_{c}$}} & \textcolor{red}{0} & \multicolumn{1}{c|}{X} & \textcolor{red}{4.14935}                & \textcolor{red}{5.5566}                      & \textcolor{red}{5.75416}                  & \textcolor{red}{6.011076}               & $E_b >$ gap        \\
            \multicolumn{1}{|c|}{}                           & 3 & \multicolumn{1}{c|}{X} & 2.503138               & 4.380231                    & 3.803146                 & 3.811565               & 4.326392          \\ \cline{4-4} \cline{4-4}
            \multicolumn{1}{|c|}{}                           & 5.1 & X                    & \multicolumn{1}{c|}{X} & 2.797365                    & 2.99418                  & 3.888089               & 4.630105          \\ \cline{5-5} \cline{5-5}
            \multicolumn{1}{|c|}{}                           & 6 & X                      & X                      & \multicolumn{1}{c|}{X}      & 2.83405                  & 3.492424               & 4.330678          \\ \cline{6-6} \cline{6-6}
            \multicolumn{1}{|c|}{}                           & 8 & X                      & X                      & X                           & \multicolumn{1}{c|}{X}   & 2.900768               & 5.811998          \\ \cline{7-7}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{cc||cccccc}
            ...
            \multicolumn{1}{|c|}{\multirow{4}{*}{$G^X_{c}$}} & 0 & \multicolumn{1}{c|}{X} & 4.14935                & 5.5566                     & \textcolor{green!50!black}{5.75416}                  & 6.011076               & $E_b >$ gap        \\
            \multicolumn{1}{|c|}{}                           & 3 & \multicolumn{1}{c|}{X} & 2.503138               & 4.380231                    & \textcolor{green!50!black}{3.803146}                 & 3.811565               & 4.326392          \\ \cline{4-4} \cline{4-4}
            \multicolumn{1}{|c|}{}                           & 5.1 & X                    & \multicolumn{1}{c|}{X} & 2.797365                    & \textcolor{green!50!black}{2.99418}                 & 3.888089               & 4.630105          \\ \cline{5-5} \cline{5-5}
            \multicolumn{1}{|c|}{}                           & 6 & X                      & X                      & \multicolumn{1}{c|}{X}      & \textcolor{green!50!black}{2.83405}                  & 3.492424               & 4.330678          \\ \cline{6-6} \cline{6-6}
            \multicolumn{1}{|c|}{}                           & 8 & X                      & X                      & X                           & \multicolumn{1}{c|}{X}   & 2.900768               & 5.811998          \\ \cline{7-7}
            \multicolumn{1}{|c|}{}                           & 9 & X                      & X                      & X                           & X                        & \multicolumn{1}{c|}{X} & 3.018396 \\  \cline{1-2} \cline{1-2} \cline{8-8}
        \end{tabular}
    \end{table}}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{cc||cccccc}
            ...
            &                                                & 0                          & 3                & 5.1              & 6              & 8                      & 9                       \\ \cline{8-8} \hline \hline
            \multicolumn{1}{|c|}{\multirow{4}{*}{$G^X_{c}$}} & 0 & \multicolumn{1}{c|}{X} & 4.14935                & 5.5566                     & 5.75416                  & 6.011076               & $E_b >$ gap        \\
            \multicolumn{1}{|c|}{}                           & 3 & \multicolumn{1}{c|}{X} & \textcolor{blue!50!black}{2.503138}                  & 4.380231                    & 3.803146                 & 3.811565               & 4.326392          \\ \cline{4-4} \cline{4-4}
            \multicolumn{1}{|c|}{}                           & 5.1 & X                    & \multicolumn{1}{c|}{X} & 2.797365                    & \textcolor{blue!50!black}{2.99418}                 & 3.888089               & 4.630105          \\ \cline{5-5} \cline{5-5}
            \multicolumn{1}{|c|}{}                           & 6 & X                      & X                      & \multicolumn{1}{c|}{X}      & 2.83405                  & 3.492424               & 4.330678          \\ \cline{6-6} \cline{6-6}
            \multicolumn{1}{|c|}{}                           & 8 & X                      & X                      & X                           & \multicolumn{1}{c|}{X}   & \textcolor{blue!50!black}{2.900768}               & 5.811998          \\ \cline{7-7}
            \multicolumn{1}{|c|}{}                           & 9 & X                      & X                      & X                           & X                        & \multicolumn{1}{c|}{X} & \textcolor{blue!50!black}{3.018396} \\  \cline{1-2} \cline{1-2} \cline{8-8}
        \end{tabular}
    \end{table}}
    ...
    \begin{itemize}
        \onslide<2->{\item \textcolor{red}{For $G^X_c = 0$, $E_b$ increases with increasing $G^{\varepsilon}_c$ (decreased screening)}}
    \end{itemize}

    
    \begin{itemize}
        \onslide<3->{\item For $G^X_c = 0$, $E_b$ increases with increasing $G^{\varepsilon}_c$ (decreased screening)
    ...
    \begin{itemize}
        ...
        \item For a given $G^{\varepsilon}_c$, $E_b$ converges w/ increasing $G^X_c$ (somewhat)
         \item \textcolor{blue!50!black}{Quite remarkably, $E_b$ converges!}}
    \end{itemize}
\end{frame}
