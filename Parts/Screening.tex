...
\begin{frame}{The quasi-2D approach for screening}
    ...
    We can work within a quasi-2D (Q2D) framework, where the dielectric function in the mixed representation as
    ...
    with the $(\bq,z)$-resolved polarizability
...
\begin{frame}{The Q2D dielectric function}
    ...
    \end{empheq}}
\onslide<5->{But how does $\bar{\varepsilon}_{\bG \bG'}(\bq)$ improve our dielectric function?}
\end{frame}
...
\begin{frame}{The Q2D dielectric function: numerical results}
    ...
    \begin{figure}[h]
         \centering
         \includegraphics[width=0.6\textwidth]{Figures/epsilon_M_vs_q_hBN_&_MoS2.pdf}
