...
\begin{frame}{Macroscopic dielectric function: Results}
    ...
    \begin{columns}
        ...
        \onslide<6->{   
            ...
            \end{figure}
            \vspace{-0.3cm}
            \small S.~Latini, T.~Olsen, K.~S. Thygesen - \textit{Phys. Rev. B} \textbf{92} 245123\\ \hspace{7.5cm} (2015)}
    \end{columns}    
\end{frame}
...
\begin{frame}{Q2D Dielectric Function: Results}
    \begin{columns}
        ...
        \end{figure}}
         ...
         \onslide<3->{\small [1] K.~Andersens et al. - \textit{Nano Lett.} \textbf{15} 7 (2015)}
        ...
        \begin{itemize}
            ...
            \item<7-> Very good agreemment with the literature! \\For \ch{MoS2} $r_0 \approx 32$ \AA; for \ch{GeS} $r_0 \approx 20$ \AA
        \end{itemize}
