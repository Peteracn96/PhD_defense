...
Excitons are important, both theoretically and experimentally, for:

-Studying light--matter interactions in different regimes of coupling strength and develop new applications

-To experimentally build single-photon sources
to fabricate coherent light sources

-Induce nonlinear optical phenomena, such as the excitonic shift-current

-Useful in the field of valleytronics by enhancing the degree of
valley polarization by stacking layers of excitonic materials,
resulting in intensified circular dichroism, which can be used
for improving error detection in optical communications,
or study chiral molecules of biological relevance, like proteins
and nucleic acids
...
-To determine the excitonic effects in this new material, we adopt a Wannier description of the
electron-hole two-body problem as we took the low-energy limit in the Hamiltonian,
for which the band dispersion is quadratic
...
SLIDE 13
-We look at the excitonic conductivity, which is in general a tensor
...
SLIDE 18
Work is collaboration POLIMA and UAM
...
-From which we can define a macroscopic 2D potential and dielectric function diele. f. as
...
more refined description than the Wannier one
...
-Fixing G^X_c = 0, the binding energy increases-> due to overscreening in the interaction->back to 25 and return to 27
...
to justify the strict 2d approach and improve on it
